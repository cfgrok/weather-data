...
Unreloader = Rack::Unreloader.new(subclasses: %w'Roda Sequel::Model', logger: logger, reload: dev){WeatherData}
require_relative 'models'
Unreloader.require('app.rb'){'WeatherData'}
run(dev ? Unreloader : WeatherData.freeze.app)
